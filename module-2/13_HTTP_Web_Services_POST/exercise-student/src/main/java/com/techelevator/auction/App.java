...
public class App {
    ...
    public static final String API_KEY = "03017";
	...
	public static void main(String[] args) {
		...
		AuctionService auctionService = new AuctionService(API_URL, API_KEY);
		...
		while (true) {
			...
			if (menuSelection == 1) {
				...
				if (auction == null) {
					System.out.println(
							"Invalid auction. Please enter the Title, Description, User, Current Bid Price (no dollar sign).");
				} else {
